...
public class LibroPropuestoAdapter extends RecyclerView.Adapter<LibroPropuestoAdapter.LibroViewHolder> {
    ...
    // Añadir esto a tu LibroPropuestoAdapter.java
    public void updateData(List<BookEn> nuevosLibros, int nuevoTotal) {
        this.libros.clear();
        this.libros.addAll(nuevosLibros);
        this.totalMiembrosGrupo = nuevoTotal; // Asegúrate de tener esta variable en el adapter
